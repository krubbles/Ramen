...
public static class TrainingData
{
    ...
    {
        AugmentTrainingDataBySuitRemap(EvaluationTrainingData, includeIdentity);
    }
    ...
    static int[][] CreateSuitRemapPermutations()
    {
        ...
        BuildSuitRemapPermutations(0, suits, current, permutations);
        return permutations.ToArray();
    }

    static void BuildSuitRemapPermutations(int depth, int[] suits, int[] current, List<int[]> permutations)
    {
        ...
        for (int i = depth; i < suits.Length; ++i)
        {
            ...
            BuildSuitRemapPermutations(depth + 1, suits, current, permutations);
        }
    }
